            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="width:50%;">
                <div class="modal-content modal-content-demo" id="create_modal_content">
                    <div class="modal-header">
                        <h6 class="modal-title">Add New</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <form id="form_create">
                            ...
                            <div class="row row-sm" style="padding-top: 0;">
                                <div class="col-md-12">
                                    <label for="role_name" class="form-control-label">Role Name: <span class="tx-danger">*</span></label>
                                    <input class="form-control" id="role_name" name="role_name" placeholder="" required="" type="text">
                                </div>
                            </div>

                            <div class="row row-sm" style="padding-top: 15px;">
                                <div class="col-lg-12">
                                    <label for="guard" class="form-control-label">Guard:</label><br>
                                    <select style="width: 100%;" required="" class="form-control create_select" name="guard" id="guard">
...
@section('scripts')
    ...
    <script>
        ...
        function create() {
            ...
            let guard = $("#guard option:selected").val();

            if(role_name === '') {
                show_toast('Caution!', 'Please Enter Role Name', 'warning');
                return;
            }
